...
export function PostCard({ post }: { post: PostWithTags }) {
  return (
    <article className="flex flex-col overflow-hidden rounded-lg border border-border bg-card transition-colors hover:border-primary/60">
      {post.coverImage && (
        <div className="relative h-44 w-full bg-muted">
          <Image
            ...
            alt=""
            fill
            // sizes подсказывает браузеру реальный размер карточки, чтобы
            // не скачивать картинку в разрешении больше нужного.
